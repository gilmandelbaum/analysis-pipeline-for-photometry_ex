...
Currently (will change in the future..) the previous notebook 6 must be run in order to run the next. For example if you are running 0a1b2a3b4abcd5a6abc7a you must run 0a1b2a3b4abcd5a6ab7a before. 
